...
class PagantisPs17InstallTest extends AbstractPs17Selenium
{
    ...
    {
        $this->findByCss('#is_enabled_on + label')->click();
        $this->findById('public_key')->clear()->sendKeys('tk_0754e2c7e470f9f5f903b1be');
        $this->findById('private_key')->clear()->sendKeys('7fc84d431b38fb2b');
