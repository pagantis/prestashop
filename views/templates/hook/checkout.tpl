...
<div class="row">
    <div class="col-xs-12">
        <p class="payment_module Pagantis ps_version_{$ps_version|escape:'htmlall':'UTF-8'}">
            <a class="pagantis-checkout ps_version_{$ps_version|escape:'htmlall':'UTF-8'} locale_{$locale|escape:'htmlall':'UTF-8'}" href="{$paymentUrl|escape:'html'}" title="{$pagantisTitle|escape:'htmlall':'UTF-8'}">
                {if $ps_version !== '1-7'}{$pagantisTitle|escape:'htmlall':'UTF-8'}&nbsp;{/if}
